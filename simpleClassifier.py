...
# Creating MLP Classifier with one hidden layer of 3 nodes
...
for name, clf in zip(name, classifiers):
    ...
    print('power of test with respect to signal', name, ' = ', power)
    ...
    plt.savefig("scatterplot_"+name+".pdf", format='pdf')
    ...
    plt.savefig("decision_function_hist_"+name+".pdf", format='pdf')
